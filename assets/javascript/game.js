...
const wordJar = ["SLAYER", "PANTERA", "METALLICA", "MEGADETH", "EXPIRE", "GOJIRA", "SLIPKNOT", "MOTORHEAD", "INTEGRITY", "ANTHRAX", "SEPULTURA", "MASTODON",
                 "MAYHEM", "VENOM", "OPETH", "DARKTHRONE", "ABBATH", "BATUSHKA", "TOOL", "INCENDIARY", "TERROR", "MANOWAR", "DEATH", "PRIMUS", "HELLOWEEN",
                 "BATHORY", "BEHEMOTH", "CONVERGE", "PALLBEARER", "COUNTERPARTS", "RINGWORM", "NAILS", "BARONESS", "GAZA", "HAKEN", "CURSED", "BURZUM", "WATAIN",
                 "OBITUARY", "VADER", "NILE", "CLUTCH", "MISFITS"];
